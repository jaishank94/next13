...
const MissionSection = async () => {
  ...
  return (
    <section
      className="group bg-[#f6f6f6] px-4 md:px-16 pb-24 cursor-default transition duration-200 ease-in"
      id="mission"
    >
      ...
      <div className=" text-white py-28">
        <div className="pt-12 md:pt-24 flex flex-col px-4 lg:px-16 text-4xl font-medium">
          ...
          <div className="mt-4 text-sm md:text-base text-gray-700 tracking-wide font-light  lg:text-lg py-16">
            {missionData &&
