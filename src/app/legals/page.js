            ...
            <div className=" mt-12 md:mt-4 md:mt-0 text-left flex flex-col h-full col-span-2">
              ...
              <div id="privacy">
                ...
                <p className="text-sm md:text-base tracking-wide text-black font-light text-md text-gray-700 lg:text-lg">
                  ...
                  orci dapibus ultrices in iaculis nunc sed mauris ultrices eros
                  in cursus turpis massa itae ultricies leo integer malesuada
                  utrum tellus pellentesque eu tincidunt tortor aliquam nulla
                  facilisi cras ibh mauris cursus mattis molestie a iaculis u
                  non diam phasellus vestibulum lorem sed risus ultricies t
                  malesuada fames ac turpis egestas maecenas pharetra convallis
                  it amet volutpat consequat mauris nunc congue nisi vitae
                  suscipit auris rhoncus aenean vel elit scelerisque mauris
                  pellentesque gestas erat imperdiet sed euismod orem ipsum
